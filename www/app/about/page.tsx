          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="text-center">
                ...
                <div className="mb-8">
                  <img src="/about-us/vision.png" alt="Vision" className="w-full max-w-md mx-auto mb-6 object-contain" />
                </div>
              ...
              <div className="text-center">
                ...
                <div className="mb-8">
                  <img src="/about-us/mission.png" alt="Mission" className="w-full max-w-md mx-auto mb-6 object-contain" />
                </div>
                <div className="text-left">
                  <p className="text-lg text-gray-600 leading-relaxed">
