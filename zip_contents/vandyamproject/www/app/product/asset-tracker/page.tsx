...
import { getProductByRoute } from "@/lib/products";

// Cache the product data
const product = getProductByRoute("asset-tracker");
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-teal-600 to-green-600 text-white py-10 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image src="/products/forest.png" alt="Background" fill className="object-cover opacity-30" priority />
        </div>
