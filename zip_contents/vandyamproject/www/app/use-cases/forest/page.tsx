...
export default function ForestPage() {
  const { heading, title, description, image, link, challenges, solutions } = USE_CASES.forest;
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img src="/use-case/forest/forest.jpg" alt="Forest background" className="w-full h-full object-cover" />
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="rounded-lg overflow-hidden">
                <img src="/use-case/forest/forest-bg.png" alt="Forest monitoring dashboard" className="w-full h-64 object-cover rounded-lg" />
              </div>
            </div>
                ...
                {challenges.map((challenge, index) => (
                  <Card key={index} className="text-center p-6">
                    <CardHeader className="pb-4">
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 ${challenge.bgColor}`}>
                        <span className={`text-xl ${challenge.bgColor}`}>{challenge.emoji}</span>
                      </div>
