...
export default function HighwayPage() {
  const { heading, title, description, image, link, challenges, solutions } = USE_CASES.highway;
    ...
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img src="/use-case/highway/highway-section.png" alt="Highway background" className="w-full h-full object-cover" />
        </div>
