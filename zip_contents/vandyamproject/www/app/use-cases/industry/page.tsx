...
export default function IndustryPage() {
  const { heading, title, description, image, link, challenges, solutions } = USE_CASES.industry;
    ...
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img src="/use-case/industry/industry-section.png" alt="Industry background" className="w-full h-full object-cover" />
        </div>
